...
public interface SqlDataSetFileConfig {
    ...
    public static final ConfigProperty<DatabaseConnectionPool> DATABASE_CONNECTION_BORROWER = ConfigProperty.named("databaseConnectionBorrower").typed(DatabaseConnectionPool.class);
    ...
    DatabaseConnectionPool getDatabaseConnectionBorrower();
}
