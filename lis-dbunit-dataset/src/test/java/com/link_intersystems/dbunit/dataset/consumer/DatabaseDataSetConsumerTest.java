...
class DatabaseDataSetConsumerTest {
    ...
    void endDataSet() throws SQLException, DatabaseUnitException, IOException {
        ...
        LENIENT.assertDataSetNotEquals(tinySakilaDataSet, databaseDataSet);
        ...
        LENIENT.assertDataSetEquals(tinySakilaDataSet, dataSet);

        databaseDataSet = new DatabaseDataSet(databaseConnection, false, dbTablesFilter);
        LENIENT.assertDataSetEquals(tinySakilaDataSet, databaseDataSet);
    }
}